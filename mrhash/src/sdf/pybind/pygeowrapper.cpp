...
NB_MODULE(pygeowrapper, m) {
  nb::class_<GeoWrapper>(m, "GeoWrapper")
    ...
    .def("setMaskOutputPath", &GeoWrapper::setMaskOutputPath, nb::arg("path"))
     ...
     .def("enableDynamicFusion", &GeoWrapper::enableDynamicFusion, nb::arg("enable"))
     .def("isDynamicFusionEnabled", &GeoWrapper::isDynamicFusionEnabled)
     .def("setDynamicFusionWeights", &GeoWrapper::setDynamicFusionWeights, nb::arg("uncertainty_weight"), nb::arg("tsdf_weight"))
     .def("setDynamicFusionThreshold", &GeoWrapper::setDynamicFusionThreshold, nb::arg("threshold"))
     ...
     .def("setExternalDynamicProbability", &GeoWrapper::setExternalDynamicProbability, nb::arg("probability"))
    ...
    .def("hasTSDFResidualImage", &GeoWrapper::hasTSDFResidualImage)
    .def("getTSDFResidualImage", &GeoWrapper::getTSDFResidualImage)
